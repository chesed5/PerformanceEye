...
EXEC @ReturnCode =  msdb.dbo.sp_add_job @job_name=@JobName, 
		...
		@notify_level_page=0, 
		@delete_level=0, 
		@description=N'This job is started by the PerfEye Master job and starts a DMV polling trace against the session-focused DMVs that (by default) lasts all day.', 
